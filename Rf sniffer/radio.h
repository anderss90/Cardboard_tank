...
#define kMinPulseWidth 140*2
#define kMaxPulseWidth 300*2 //210
// Minimum time between two pulsetrains
#define kPulseTrainDelay 9700*2
// Minimum time between init pulse and data stream
#define kMinInitDelay 2200*2 //2600
#define kMaxInitDelay 2800*2
// Maximum time between two data pulses
#define kMaxDataDelay 1450*2 //1363
// A delay longer than reads as a '1'
#define kZeroDelay 687*2 //346
